...
public class JSONServlet extends HttpServlet{
	...
	public void init(ServletConfig config) throws ServletException {
		...
		articles.add(new Article("小说", "罪恶之城", "烟雨江南", "sin_rain@sina.com.cn", changeTime(2015, 6, 20)));
		articles.add(new Article("玄幻", "凡人修仙传", "天蚕土豆", "potato@163.com", changeTime(2008, 10, 15)));
		
	}
	private String changeTime(int year,int month,int date){
		Calendar c = Calendar.getInstance();
		c.set(year, month, date);
		return new SimpleDateFormat("yyyy年mm月dd日").format(new Date(c.getTimeInMillis()));
	}
}